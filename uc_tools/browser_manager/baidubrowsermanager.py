...
class BaiduBrowserManager(browsermanager.BrowserManager):
    """ 百度浏览器管理类，封装了启动浏览器、加载URL，关闭浏览器等方法
    """
    ...
    def removeWelcomePage(self):
        """ 移除新手教育界面
        """
        parent = super(BaiduBrowserManager, self)
    ...
    def cleanCache(self):
        ...
        self.cmd_exec.sendShellCommand("rm -r /data/data/" + self.pkg_name + "/app_appcache_sys")
